                    ...
                    <div class="search">
                        ...
                        <div class="p-1 bg-light radius rounded-pill shadow-sm mb-4">
                            <div class="input-group">
                                <input type="search" name="q" placeholder="Tìm tên sản phẩm, danh mục, thương hiệu,..." aria-describedby="button-addon1" class="form-control border-0 bg-light">
                            ...
                            <li>
                                <div class="cart location" onclick="window.location.href='cart.php'">
                                    ...
                                    <?php
                                        ...
                                        $get_total = "select count(MSHH) as total from giohang where MSGH='$gh'";
                            ...
                            <li class="hv">
                                <div class="user">
                                    <?php if (isset($_SESSION['login_user'])) : ?>
                                        <div onclick="window.location.href='customer/my_account.php'">
